<template>
  <page-header-wrapper>
    <a-card :loading="cardLoading">
              ...
              <a-row :gutter="48">
                ...
                <a-col :md="5" :sm="24">
                  <div class="btn-wrapper">
                    <a-button type="primary" @click="openModal"><a-icon type="plus"/>新增</a-button>
                  </div>
                </a-col>
              </a-row>
            </div>
                ...
                <template slot="action" slot-scope="text,record">
                  <div>
                    <a-popconfirm
                      ...
                      ok-text="确认"
                      cancel-text="取消" >
                      <a-icon type="delete" style="font-size:18px;color:#3C92FF; cursor: pointer;;"/>
                    </a-popconfirm>
                  </div>
                </template>
              </s-table>
      ...
      <a-modal :visible="visible" title="新增" @ok="modalOk" @cancel="modalCancel" :width="700">
        <div class="form-wrapper" style="padding:16px;">
          <a-form-model
            ref="ruleForm"
            :model="form"
            :rules="rules"
            ...
            <a-form-model-item label="字典编码" prop="metaCode">
              <a-input v-model="form.metaCode" :disabled="codeDisabled"/>
            </a-form-model-item>
            <a-form-model-item label="字典编码中文" prop="metaName">
