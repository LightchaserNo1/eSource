      ...
      <div class="main">
        ...
        <table>
          ...
          <tr>
            ...
            <td>上传人姓名</td>
            <td>
              <span v-if="item.auditStatus === 1">{{ item.reviewerName }}</span>
            </td>
          </tr>
          <tr>
            <td>签名时间</td>
            ...
            <td>签名时间</td>
            <td>
              <span v-if="item.auditStatus === 1">{{ item.reviewerDate | dayjs }}</span>
            </td>
          </tr>
          <tr>
            <td>说明</td>
            ...
            <td>说明</td>
            <td>
              <span v-if="item.auditStatus === 1">本人承诺上传文件与源文件容一致！</span>
            </td>
          </tr>
        </table>
        </div>
        ...
        class="txt"
        v-if="$isCenter">
          <div class="txt-value">文字识别</div>
          <a-button
            v-if="item.ocrText === null"
            :disabled="item.auditStatus !== 1"
            @click="ocr(item.ocrText, item.imageAt, item.id, index)"
            type="primary"
            style="width: 168px"
