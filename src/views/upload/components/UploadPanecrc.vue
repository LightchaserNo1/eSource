...
import uploadForm from './uploadFormcrc.vue'
import { listType, listTrilStage, addOrUpdate, Login, listCerByPage } from '@/api/update/update'
// submitReview
export default {
  components: {
    PersonForm,
      ...
      formData: [
        {
          ...
          signImg: '', // 上传人签名图片
          ptsId: this.$route.query.ptsId || '', // 受试者ID
