  ...
  <div>
    <a-row
        ...
        >
          ...
          <p
            ...
            <span
              ...
              @click.stop="deleteImg(index)">删除</span>
          </p>
          <img
            src="../img/upload-empty.png"
            v-else />
        </a-upload>
      </a-col>
      <a-col
        ...
        <div
          class="tuoMing"
          v-if="!item.imageAt"
          @click="handleTuomin(item.imageOriginal, index)">
      ...
      <a-col
        :span="6"
        class="beizhu">
        <span><span class="red">*</span>备注</span>
        <div>
          <a-textarea
            disabled
            style="width: 200px"
...
export default {
  ...
  methods: {
    ...
    beforeUpload (file) {
      ...
      if (!isImg) {
        this.$message.error('只能上传jpeg、png、jpg图片格式!')
      }
